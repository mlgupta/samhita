...
<%request.setAttribute("topic","permission_bundle_new_html");%>

<html:html> 

<head>

<title><bean:message key="title.PermissionBundleNew" /></title>
...
<html:form action="/permissionBundleNewAdminAction" onsubmit="return validatePermissionBundleNewEditForm(this);" focus="txtPermissionBundleName" >    
    ...
    <td>
      ...
      <table id="tab" width="150px" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.NewPermission" /></div></td>
      ...
      <tr>
        ...
        <td colspan="2" align="center">
          ...
          <tr>
            ...
            <td width="65%"><html:text property="txtPermissionBundleName" styleClass="borderClrLvl_2 componentStyle" style="width:300px" tabindex="1" maxlength="20" /></td>
          ...
          <tr>
            ...
            <td rowspan="3" valign="top"><html:textarea property="txaPermissionBundleDescription" rows="4" styleClass="borderClrLvl_2 componentStyle" style="width:300px" tabindex="2" /></td>
    ...
    <tr>
      ...
      <td height="5px" colspan="2" align="center"></td>
        ...
        <td >
          ...
          <html:select name="permissionBundleNewEditForm" property="lstAvailablePermission" size="10"  multiple="true" style="width:200px; height:175px" styleClass="borderClrLvl_2 componentStyle" tabindex="3" >
        ...
        <td >
          ...
          <table id="nav" width="100%"  border="0">
            ...
            <tr>
              ...
              <td><html:button property="btnLeft2Right" styleClass="buttons" style="width:30px" value="&gt;" titleKey="tooltips.Move" onclick="moveBetweenListBox(this.form, 'L2R')" tabindex="4" /></td>

            </tr>

            <tr>

              <td><html:button property="btnLeft2RightAll" styleClass="buttons" style="width:30px" value="&gt;&gt;" titleKey="tooltips.MoveAll" onclick="moveAllBetweenListBox(this.form, 'L2R')" tabindex="5" /></td>
            ...
            <tr>
              ...
              <td><html:button property="btnRight2LeftAll" styleClass="buttons" style="width:30px" value="&lt;&lt;" titleKey="tooltips.RemoveAll" onclick="moveAllBetweenListBox(this.form, 'R2L')" tabindex="6" /></td>

            </tr>

            <tr>

              <td><html:button property="btnRight2Left" styleClass="buttons" style="width:30px" value="&lt;" titleKey="tooltips.Remove" onclick="moveBetweenListBox(this.form, 'R2L')" tabindex="7" /></td>
          ...
          <td width="200px">
            ...
            <html:select property="lstSelectedPermission" size="10"  multiple="true" style="width:200px; height:175px" styleClass="borderClrLvl_2 componentStyle" tabindex="8" >
      ...
      <html:button property="btnSave" styleClass="buttons" style="width:70px" onclick="return callPage(this.form)" tabindex="9" ><bean:message key="btn.Save" /></html:button>
