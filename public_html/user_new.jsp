...
<%request.setAttribute("topic","user_new_html");%>

<html:html> 

<head>

<title><bean:message key="title.UserNew" /></title>
...
<html:form action="/userNewAdminAction" focus="txtUserName"
    ...
    <td>
      ...
      <table width="150" border="0" cellpadding="0" cellspacing="0" id="tab">
        ...
        <tr>
          ...
          <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.NewUser" /></div></td>
...
<table id="borderClrLvl_2" width="990px" border="0" cellpadding="0" cellspacing="0" class="imgData bgClrLvl_4 borderClrLvl_2" >
      ...
      <tr>
        ...
        <fieldset style="width:965px;">
          ...
          <table width="965px" border="0" id="general">

            <tr>

              <td width="14%"><div align="right"><bean:message key="txt.UserName" /></div></td>

              <td width="25%"><html:text  property="txtUserName" styleClass="borderClrLvl_2 componentStyle" style="width:200px" maxlength="20" tabindex="1" /></td>

              <td width="13%"><div align="right"><bean:message key="txt.Password" /></div></td>

              <td width="24%"><html:password  property="txtPassword" styleClass="borderClrLvl_2 componentStyle" style="width:155px"  redisplay="false" maxlength="20" tabindex="5" /></td>

              <td width="24%" rowspan="7" valign="top">
                  ...
                  <table width="210px" border="0" cellpadding="1">
                    ...
                    <tr height="30px">
                      ...
                      <td>
                        ...
                        <html:button property="btnAddFromGroupList" styleClass="buttons" style="width:205px" onclick="openWindow('relayAction.do?operation=page_group_select&control=lstGroupOrUserList','userNewGroup',515,450,0,0,true);" tabindex="9" ><bean:message key="btn.AddFromGroupList" /></html:button>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <html:text name="userNewEditForm" property="txtGroupName" styleClass="borderClrLvl_2 componentStyle componentStyleDisable" style="width:135px" value="" readonly="true" />

                        <html:button property="btnAdd" styleClass="buttons" style="width:65px" tabindex="10" ><bean:message key="btn.Add" /></html:button>
          ...
          <tr>
            ...
            <td>
              ...
              <html:password  name="userNewEditForm" property="txtConfirmPassword" styleClass="borderClrLvl_2 componentStyle" style="width:155px" redisplay="false" maxlength="20" tabindex="6" />
          ...
          <tr>
            ...
            <td>
              ...
              <html:button property="btnAccessControlList" styleClass="buttons" style="width:20px;height:17px;" value="..." onclick="openWindow('relayAction.do?operation=page_acl_select&control=txtAccessControlList&forUser=true','userNewSystemAcl',505,620,0,0,true);" tabindex="4" />
      ...
      <tr>
        ...
        <td align="center" >
            ...
            <table width="965px" border="0" id="profile" cellpadding="1" cellspacing="1">
              ...
              <tr>
                ...
                <td>
                  ...
                  <html:radio name="userNewEditForm" property="radQuota" value="1" tabindex="14" />

                  <bean:message key="rad.Quota.Limited" /> &nbsp;

                  ( <bean:message key="rad.Quota.Storage" />

                    <html:text name="userNewEditForm"  property="txtQuota" styleClass="borderClrLvl_2 componentStyle" style="width:45px;text-align:right" maxlength="3" tabindex="15" onkeypress="return decimalOnly(this,event,1)"/>
                ...
                <td valign="top">
                  ...
                  <html:select property="cboCharacterSet" styleClass="borderClrLvl_2 componentStyle" style="width:155px" tabindex="21" >
                    ...
                    <option value="ISO8859_6">Arabic (ISO-8859-6)</option>

                    <option value="ISO8859_4">Baltic (ISO-8859-4)</option>

                    <option value="ISO8859_2">Central European (ISO-8859-2)</option>

                    <option value="EUC_CN">Chinese Simplified (GB2312)</option>

                    <option value="MS936">Chinese Simplified (GBK)</option>

                    <option value="MS950">Chinese Traditional (Big5)</option>

                    <option value="EUC_TW">Chinese Traditional (EUC-TW)</option>

                    <option value="ISO8859_5">Cyrillic (ISO-8859-5)</option>

                    <option value="ISO8859_7">Greek (ISO-8859-7)</option>

                    <option value="ISO8859_8">Hebrew (ISO-8859-8)</option>

                    <option value="EUC_JP">Japanese (EUC-JP)</option>

                    <option value="MS932">Japanese (SHIFT_JIS)</option>

                    <option value="EUC_KR">Korean (KS_C_5601-1987)</option>

                    <option value="TIS620">Thai (TIS-620)</option>

                    <option value="ISO8859_9">Turkish (ISO-8859-9)</option>

                    <option selected value="UTF8">Unicode (UTF-8)</option>

                    <option value="Cp1258">Vietnamese (Windows-1258)</option>

                    <option value="ISO8859_1">Western (ISO-8859-1)</option>
              ...
              <tr>
                ...
                <td>
                    ...
                    <html:radio name="userNewEditForm" property="radQuota" value="2" tabindex="14" />
                ...
                <html:button  property="btnDefaultDocumentAcl" styleClass="buttons" style="width:20px;height:17px;" value="..." onclick="openWindow('relayAction.do?operation=page_acl_select&control=txtDefaultDocumentAcl','userNewDocumentAcl',505,620,0,0,true);" tabindex="18" />
                ...
                <td>
                  ...
                  <html:select property="cboLocale" styleClass="borderClrLvl_2 componentStyle" style="width:155px" tabindex="22" >
                    ...
                    <option selected value="en_US">American (en-US)</option>

                    <option value="en_GB">English (en-GB)</option>

                    <option value="es_ES">Spanish (es-ES)</option>

                    <option value="es">Latin American Spanish (es)</option>
                    ...
                    <option value="pt_BR">Brazilian Portuguese (pt-BR)</option>

                    <option value="zh_CN">Simplified Chinese (zh-CN)</option>

                    <option value="zh_TW">Traditional Chinese (zh-TW)</option>
              ...
              <tr>
                ...
                <td>
                  ...
                  <html:button property="btnDefaultFolderAcl" styleClass="buttons" style="width:20px;height:17px;" value="..." onclick="openWindow('relayAction.do?operation=page_acl_select&control=txtDefaultFolderAcl','userNewFolderAcl',505,620,0,0,true);" tabindex="19" />
              ...
              <tr>
                ...
                <td valign="top"><div align="right"><bean:message key="txt.WorkFlowAcl" /></div></td>
                  ...
                  <td>
                    ...
                    <html:button property="btnWorkFlowAcl" styleClass="buttons" style="width:20px;height:17px;" value="..." onclick="openWindow('relayAction.do?operation=acl_select_workflow&control=txtWorkFlowAcl&txtSearchByAclName=wf','userNewFolderAcl',505,620,0,0,true);" tabindex="19" />
...
<!-- borderClrLvl_2 table ends above-->
    ...
    <td align="center">
      ...
      <table class="borderClrLvl_2 imgStatusBar bgClrLvl_4 " width="990px" height="20px" border="0" cellpadding="0" cellspacing="0" id="statusBar">
