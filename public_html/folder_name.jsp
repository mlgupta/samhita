...
function folderNew(thisForm){
    if(thisForm.hdnFolderName.value==null || trim(thisForm.hdnFolderName.value)==""){
      ...
      //alert(opener.document.forms[0].hdnTargetFolderPath.value);
      //return;
...
<html:form name="folderNewForm" action="folderNewAction"  type="dms.web.actionforms.filesystem.FolderNewForm" focus="hdnFolderName">
    ...
    <td >
      <table width="97%" border="0" cellpadding="0" cellspacing="0" align="center" >
        ...
        <tr>
          ...
          <td> 
            <html:text property="hdnFolderName" style="width:400px;left-margin:4px" styleClass="borderClrLvl_2 componentStyle" onkeypress="return enter(this,event);" ></html:text>
          </td>
        </tr>
        <tr>
