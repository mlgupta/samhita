...
<html:html>
<head>
<title><bean:message key="title.ChangeEncryptionDecryptionPassword" /></title>
<jsp:include page="/style_sheet_include.jsp" />
<script src="general.js"></script>
<html:javascript formName="changeEncryptionPasswordForm" dynamicJavascript="true" staticJavascript="false"/>
...
function callPage(thisForm){ 
  if(validateChangeEncryptionPasswordForm(thisForm)){
...
<td align="center">
      ...
      <td>
        <table id="tab" width="150px" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.EncryptPassword" /></div></td>
  ...
  <html:form name="changeEncryptionPasswordForm" type="dms.web.actionforms.user.ChangeEncryptionPasswordForm"  action="/changeEncryptionPasswordAction" onsubmit="return validateChangeEncryptionPasswordForm(this);">  
    <tr>
      <td width="398px" height="25px" align="center">
        <table width="100%"  border="0">
          ...
          <tr>
          <td width="33%"><div align="right"><bean:message key="txt.OldPassword" /></div></td>
          <td width="67%"><html:password name="changeEncryptionPasswordForm" property="txtOldPassword" styleClass="borderClrLvl_2 componentStyle " style="width:100%" /></td>  
          </tr>
          <tr>
            <td><div align="right"><bean:message key="txt.Password" /></div></td>
            <td><html:password name="changeEncryptionPasswordForm" property="txtPassword" styleClass="borderClrLvl_2 componentStyle " style="width:100%" redisplay="false" /></td>
          </tr>
          <tr>
            <td><div align="right"><bean:message key="txt.ConfirmPassword" /></div></td>
            <td><html:password name="changeEncryptionPasswordForm" property="txtConfirmPassword" styleClass="borderClrLvl_2 componentStyle" style="width:100%" redisplay="false" /></td>
          </tr>
        </table>
      </td>
    </tr>
