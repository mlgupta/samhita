...
<%request.setAttribute("topic","theme_edit_html");%>
<html:html>
<head>
<title><bean:message key="title.ThemeEdit" /></title>
<STYLE type="text/css">
.tdSelected
{
...
<script language="Javascript1.1" >
  function callPage(thisForm){ 
    if(validateThemeNewEditForm(thisForm)){
      thisForm.action="themeEditAction.do"
...
<html:form name="themeNewEditForm" type="dms.web.actionforms.theme.ThemeNewEditForm" action="/themeEditAction"  >
...
<td align="center" >
	<table id="tabParent" width="700px"  border="0" cellpadding="0" cellspacing="0">
    	...
    	<td>
            ...
            <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.EditTheme" /></div></td>
      ...
      <tr>
        <td colspan="2" align="center">
		  ...
		  <!-- This table contains 4 tr with Theme Elements, Choices, Preview -->
            ...
            <tr>
              <td colpan="2" class="borderClrLvl_2" width="35%" height="120px" valign="top" bordercolor="#666666" bgcolor="#FFFFFF" align="center">
              <div style="overflow:auto; height:120px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                  <tr>
                    <td width="20px"><div class="imgStyles"></div></td>
                    <td  id="selectedObjThemes" class="tdSelected"  style="cursor:default" onClick="tdClickThemes(this); MM_showHideLayers('styleDrop','','show','colorDrop','','hide','fontDrop','','hide','backgroundDrop','','hide');">
                    &nbsp;<bean:message key="lbl.Styles" /></td>
                  </tr>
                  <tr>
                    <td><div class="imgFontSelect"></div></td>
                    <td class="tdUnselected"  style="cursor:default" onClick="tdClickThemes(this); MM_showHideLayers('styleDrop','','hide','colorDrop','','hide','fontDrop','','show','backgroundDrop','','hide');">
                    &nbsp;<bean:message key="lbl.Fonts" /></td>
                  </tr>
                  <tr>
                    <td><div class="imgBackgroundSelect"></div></td>
                    <td class="tdUnselected"  style="cursor:default" onClick="tdClickThemes(this); MM_showHideLayers('styleDrop','','hide','colorDrop','','hide','fontDrop','','hide','backgroundDrop','','show');">
              ...
              <td colspan="2" class="borderClrLvl_2" width="65%" height="120px" valign="top" bordercolor="#666666" bgcolor="#FFFFFF" align="center">
                       ...
                       <logic:iterate name="styles" property="list" id="colorScheme">
                        <tr>
                          ...
                          <td id="<bean:write name="colorScheme" property="name" />" class="tdUnSelected" style="cursor:default" onClick="tdClickColorSchemes(this);">&nbsp;<bean:write name="colorScheme" property="value" /></td>
                            <input type="hidden" id="cs4<bean:write name="styles" property="name" />" name="" value="<bean:write name="colorScheme" property="name" />" />
                        </tr>
                        </logic:iterate>
                      </table>
                    </div>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <div id="backgroundImageDrop" style="height:85px;display:none;">
            ...
            <tr>
              <td class="borderClrLvl_2" colspan="3"  height="220px" align="center"  bordercolor="#666666" bgcolor="#FFFFFF">
      ...
      <tr>
        <td width="680px" height="30px">
          <div align="right">
            ...
            <html:text  name="themeNewEditForm" property="txtThemeName" styleClass="borderClrLvl_2 componentStyle componentStyleDisable" style="width:200px" maxlength="20" />
            <html:button property="btnSave" styleClass="buttons" style="width:70px" onclick="return callPage(this.form)" ><bean:message key="btn.Save" /></html:button>
...
<div id="ColorPicker"  style="position:absolute;display:none;" >
  ...
  <td align="center">
    ...
    <table id="ColorPickerblueBorder" width="350px" border="0" cellpadding="0" cellspacing="0"  class="imgData borderClrLvl_2 bgClrLvl_4">
      ...
      <tr>
        <td width="320px" height="30px" align="center">
          <div align="right">
