...
<html:html>
<head>
<title><bean:message key="title.SetURLEcryptionDecryptionPassword" /></title>
...
<td align="center">
  ...
  <html:form action="/setURLEncryptPasswordAction" onsubmit="return validateSetEncryptionPasswordForm(this);">  
    <tr>
