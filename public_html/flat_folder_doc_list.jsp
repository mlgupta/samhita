...
<table id="addressBar" width="100%"  border="0" cellpadding="0" cellspacing="0" class="imgToolBar bgClrLvl_3">
  <tr><td colspan="2" height="1px" class="bgClrLvl_F"></td></tr>
  <tr>
...
<table id="folderTab" width="100%" border="0" cellpadding="0" cellspacing="0" class="imgToolBar">
  <tr>
    <td valign="top" width="100%" height="25px">
      <iframe id="folderIframe" name="folderIframe" src="folderFlatListAction.do" class="imgToolBar bgClrLvl_3" style="top:0px;" height="25px" width="100%" frameborder="0" scrolling="no" ></iframe>
    </td>
  </tr>
</table>
<table id="folderNSearchTab" width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr><td height="5px"></td></tr>
  <tr>
    <td valign="top" width="100%">
      <table id="tabParentData" width="100%"  border="0" cellpadding="0" cellspacing="0" style="margin-left:5px;">
        <!-- this table is having 2 tr, 1st tr contains the 'folderDocTab' table, 2nd tr contains the 'folderNSearchIframe' iframe-->
        <tr>
          <td>
            <table id="folderDocTab" width="222px" style="height:22px;" border="0" cellpadding="0" cellspacing="0" class="imgToolBar">
              <tr>
                <td width="5px" class="imgTabLeft"></td>
                <td width="212px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.FolderDocumentList" /></div></td>
  ...
  <tr>
    <td width="100%">
      <iframe id="folderNSearchIframe" name="folderNSearchIframe" src="folderDocListAction.do?reloadTree=false" style="top:0px;" height="340px" width="100%" frameborder="0" scrolling="auto" ></iframe>
    </td>
  </tr>
  <tr>
    <td height="2px" width="100%"></td>
  </tr>
  <tr>
    <td width="100%">
      <iframe id="statusBarIframe" name="statusBarIframe" src="statusBarAction.do" style="top:0px;" height="26px" width="100%" frameborder="0" scrolling="no" ></iframe>
    </td>
  </tr>
</table>
</html:form>
