...
<head>
<title>
 <bean:message key="title.SetURLEcryptionDecryptionPassword"/>
</title>
...
<td align="center">
	<table id="tabParent" width="400px"  border="0" cellpadding="0" cellspacing="0">
    	...
    	<td>
          ...
          <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.SetURLEncryptionDecryptionPassword" /></div></td>
