...
<%request.setAttribute("topic","group_new_html");%>

<html:html> 

<head>

<title><bean:message key="title.GroupNew" /></title>
...
function openList(thisForm){
  ...
  if(thisForm.radUserGroup[0].checked){
    ...
    openWindow('relayAction.do?operation=page_user_select&control=lstGroupOrUserList','groupNewUser',500,450,0,0,true);

  }else if(document.forms[0].radUserGroup[1].checked){

    openWindow('relayAction.do?operation=page_group_select&control=lstGroupOrUserList','groupNewGroup',515,450,0,0,true);
...
<html:form action="/groupNewAdminAction" focus="txtGroupName" onsubmit="return validateGroupNewEditForm(this);" >
...
<table id="tabParent" width="700px"  border="0" cellpadding="0" cellspacing="0">
    ...
    <td>
        ...
        <tr>
          ...
          <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.NewGroup" /></div></td>
...
<table width="700px" border="0" cellpadding="0" cellspacing="0" class="imgData bgClrLvl_4 borderClrLvl_2" id="borderClrLvl_2" >
      ...
      <tr>
        ...
        <td colspan="2" align="center">
            ...
            <table width="670px" border="0" id="general" cellpadding="1" cellspacing="1" >

            <tr>

              <td width="140px"><div align="right"><bean:message key="txt.GroupName" /></div></td>

              <td colspan="2" ><html:text property="txtGroupName" styleClass="borderClrLvl_2 componentStyle" style="width:230px" tabindex="1" /></td>
              ...
              <td rowspan="3" width="240px">
                ...
                <fieldset style="width:215px;">
                    ...
                    <table width="210px" border="0" cellpadding="1"  cellspacing="1" >
                      ...
                      <tr height="10px">
                        ...
                        <!--
                          ...
                          <html:text property="txtGroupOrUserName" styleClass="borderClrLvl_2 componentStyle" style="width:135px" maxlength="20" />
                      ...
                      <tr height="70px">
                        ...
                        <td colspan="2">
                          ...
                          <html:select property="lstGroupOrUserList" size="5" multiple="true" style="width:205px" styleClass="borderClrLvl_2 componentStyle" tabindex="9">
            ...
            <tr>
              ...
              <td valign="top" colspan="2"><html:textarea property="txaDescription" styleClass="borderClrLvl_2 componentStyle" style="width:230px; height:155px" tabindex="2" /></td>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <html:text property="txtAccessControlList" styleClass="borderClrLvl_2 componentStyle componentStyleDisable" style="width:232px" readonly="true"  />

                <html:button property="btnAccessControlList" styleClass="buttons" style="width:20px;height:17px;" value="..." onclick="openWindow('relayAction.do?operation=page_acl_select&control=txtAccessControlList','groupNewAcl',505,620,0,0,true);" tabindex="4" />
