...
<html>
<head>
<title><bean:message key="title.DecryptionPassword" /> </title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<script src="general.js"></script>
<jsp:include page="/style_sheet_include.jsp" />
<script language="JavaScript" type="text/JavaScript">
//This is to submit the request for decrypting
function docDecrypt(thisForm){
    if(thisForm.txtEncryptionPassword.value==null || trim(thisForm.txtEncryptionPassword.value)==""){
      alert("<bean:message key="errors.decryptionPassword.required"/>");
...
function enter(thisField,e){
  ...
  i=handleEnter(thisField,e);
 	if (i==1) {
    return docDecrypt(thisField.form);
  }
}
...
<body>
<html:form name="docDecryptForm" action="docDecryptAction"  type="dms.web.actionforms.filesystem.DocDecryptForm" focus="txtEncryptionPassword" >
  <logic:iterate id="chkFolderDocId" property="chkFolderDocIds" name="docDecryptForm" >
          ...
          <td>
            <table id="tab" width="155px" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="145px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.decryption.password" /></div></td>
        ...
        <tr>
          <td>
            <table width="97%" border="0" cellpadding="0" cellspacing="1" align="center" >
              ...
              <tr>
                <td valign="top">
                  <div align="right"><bean:message key="lbl.decryption.password" />:&nbsp;
                  </div>
                </td>
                <td>
              ...
              <tr>
                <td colspan="2" height="30px" align="right">
                  <html:button property="btnOk" onclick="docDecrypt(this.form)" styleClass="buttons" style="width:70px"><bean:message key="btn.Ok" /></html:button>
