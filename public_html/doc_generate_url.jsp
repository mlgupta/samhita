...
<!--
function getElem(cntrl,thisForm){
  var browserName=navigator.appName; 
  if (browserName=="Microsoft Internet Explorer"){
    var index = cntrl.indexOf('[')+1;
    var textLinkValObj = "txtLinkGenerated["+cntrl.charAt(index)+"]";
    ...
    <table id="borderClrLvl_2" align="center" width="100%"  border="0" cellpadding="0" cellspacing="0" class="imgData bgClrLvl_4 borderClrLvl_2"  >
      ...
      <tr>
        <td align="center" colspan="2">
          <div style="overflow:auto;width:94%;height:320px" class="bgClrLvl_4 borderClrLvl_2">
            <table width="97%"  style="margin:3px" align="left" border="0"  cellpadding="0" cellspacing="0" id="innerTabContainer">
              ...
              <bean:define id="itemClassName" name="folderDocList" property="className" type="java.lang.String" />
              <tr class="bgClrLvl_3" >            
              ...
              <tr class="bgClrLvl_3" >
                ...
                <td>
                  <input type="TEXT" id="txtLinkGenerated[<%=index%>]" name="txtLinkGenerated[<%=index%>]" class="borderClrLvl_2 componentStyle bgClrLvl_3 " style="width:410px; margin-left:2px;" value="<%=txtLinkGenerated%>" >
                  <html:button indexed="true" property="btnOK" onclick="JavaScript:getElem(this.name,this.form);" styleClass="buttons" style="width:35px;"><bean:message key="btn.Copy" /></html:button> 
                </td>
              </tr>
