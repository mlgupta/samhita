...
<bean:define id="folderDocCheckInForm" name="folderDocCheckInForm" type="dms.web.actionforms.filesystem.FolderDocCheckInForm" />
...
<html:form name="folderDocCheckInForm" action="folderDocCheckInAction"  type="dms.web.actionforms.filesystem.FolderDocCheckInForm" >
  ...
  <tr>
    ...
    <td >
      ...
      <tr>
        ...
        <td width="122px"><html:checkbox  property="chkKeepCheckedOut" /></td>
      ...
      <tr>
        ...
        <html:textarea property="txaComment" rows="5" style="width:350;left-margin:4px" styleClass="borderClrLvl_2 componentStyle"></html:textarea>
