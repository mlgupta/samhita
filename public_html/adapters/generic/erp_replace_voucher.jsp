...
<html:form action="/genericReplaceVoucherAction" enctype="multipart/form-data" name="genericReplaceVoucherForm" type="adapters.generic.actionforms.GenericReplaceVoucherForm" >
<html:hidden name="genericReplaceVoucherForm" property="voucherId" />
<html:hidden name="genericReplaceVoucherForm" property="txtDocumentId" />
            ...
            <table width="95%"  align="left" border="0"  cellpadding="1" cellspacing="1">
              <tr>
                ...
                <tr>
                  ...
                  <td width="349">
                    <html:file name="genericReplaceVoucherForm" property="frmFile" size="48" styleClass="borderClrLvl_2" style="width:425px"><bean:message key="btn.Browse" />
                    </html:file>
                  </td>
                </tr>
                <tr>
