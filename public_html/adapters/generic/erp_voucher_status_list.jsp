<%@ page import="adapters.generic.beans.GenericAdapterConstant" %>
<%@ page import="adapters.generic.actionforms.GenericVoucherStatusListForm" %>
...
<bean:define id="pageCount" name="GenericVoucherStatusListForm" property="txtPageCount" />
<bean:define id="pageNo" name="GenericVoucherStatusListForm" property="txtPageNo" />
...
firstTableRow = true;
String status=((GenericVoucherStatusListForm)request.getAttribute("GenericVoucherStatusListForm")).getVoucherStatus();
%>

<html:html>
<head>
<title><bean:message key="title.VoucherStatus" /></title>
...
<html:javascript formName="genericVoucherStatusListForm" dynamicJavascript="true" staticJavascript="false"/>
...
<html:form name="GenericVoucherStatusListForm" type="adapters.generic.actionforms.GenericVoucherStatusListForm" action="/genericRelayAction"  >

<html:hidden name="GenericVoucherStatusListForm" property="operation" />
<html:hidden name="GenericVoucherStatusListForm" property="timezone" />
<html:hidden name="GenericVoucherStatusListForm" property="txtPageNo" />
<html:hidden name="GenericVoucherStatusListForm" property="hdnType" />
        ...
        <tr>
          ...
          <td>
            <table id="tab2" width="150px" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="5px" class="imgTabLeft"></td>
                <td width="140px" class="imgTabTile"><div align="center" class="tabTextLink"><a class="tabTextLink" href="genericVoucherReportAction.do"><bean:message key="lbl.VoucherReport" /></a></div></td>
                <td width="5px" class="imgTabRight"></td>
              </tr>
            </table>
          </td>
        ...
        <td height="30px" colspan="2" align="center">
    		<fieldset style="width:670px; margin-top:10px">
			  ...
			  <tr>
				...
				<td width="31%">
          <bean:define id="checkVoucherStatus" name="GenericVoucherStatusListForm" property="voucherStatus" />
          <html:select  name="GenericVoucherStatusListForm" property="cboInvoiceStatus" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
            
            <%
              if(checkVoucherStatus.equals(GenericAdapterConstant.INQUEUE)){
            %>
              <option selected value="<%=GenericAdapterConstant.INQUEUE%>"><bean:message key="lbl.Inqueue" /></option>
            <%}else{%>
              <option value="<%=GenericAdapterConstant.INQUEUE%>"><bean:message key="lbl.Inqueue" /></option>
            <%}%>
            
            <%
              if(checkVoucherStatus.equals(GenericAdapterConstant.INPROCESS)){
            %>
              <option selected value="<%=GenericAdapterConstant.INPROCESS%>"><bean:message key="lbl.Inprocess" /></option>
            <%}else{%>
              <option value="<%=GenericAdapterConstant.INPROCESS%>"><bean:message key="lbl.Inprocess" /></option>
            <%}%>

            <%
              if(checkVoucherStatus.equals(GenericAdapterConstant.PROCESSED)){
            %>
              <option selected value="<%=GenericAdapterConstant.PROCESSED%>"><bean:message key="lbl.Processed" /></option>
            <%}else{%>
              <option value="<%=GenericAdapterConstant.PROCESSED%>"><bean:message key="lbl.Processed" /></option>
            <%}%>
            ...
            <html:hidden name="GenericVoucherStatusListForm" property="txtFromDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px" />
              <script>
			  ...
			  <tr>
				...
				<td>
          <html:select name="GenericVoucherStatusListForm" property="voucherZone" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
            <html:options name="GenericVoucherStatusListForm" property="cboInvoiceZone" />
          </html:select>
        </td>
			    <td align="right"><bean:message key="lbl.ToDate" />:</td>
			    <td>
            <html:hidden name="GenericVoucherStatusListForm" property="txtToDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px" />
          ...
          <table class="bgClrLvl_F" id="data" width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr>
              <th width="6%" height="18px" >
                <%if(status.equalsIgnoreCase(GenericAdapterConstant.INPROCESS)){%>
              ...
              <th width="14%"><bean:message key="tbl.head.ProcessedDate" /></th>
                ...
                <% if(voucherArrayList.size()>0) {%>
                  <logic:iterate name="voucherArrayList" id="voucherArrayLists">
                    ...
                    <%}%>
                  <td>
                    <bean:define id="erpVoucherStatus" name="voucherArrayLists" property="erpVoucherStatus" />
                    <bean:define id="docId" name="voucherArrayLists" property="docID" />
                    <div align="center">
                      <logic:equal name="erpVoucherStatus" value="InProcess" >
                        <html:multibox name="GenericVoucherStatusListForm" property="radSelect" value="<%=docId%>" />
                      </logic:equal>
                      <logic:notEqual name="erpVoucherStatus" value="InProcess" >
                        <html:multibox name="GenericVoucherStatusListForm" disabled="true" property="radSelect" value="<%=docId%>" />
                      </logic:notEqual>
                    </div>
                  </td>

                  <td><bean:write name="voucherArrayLists" property="docName" /></td>
                  <td><bean:write name="voucherArrayLists" property="erpVoucherStatus" /></td>
