...
<bean:define id="sapVoucherReportForm" name="SAPVoucherReportForm" type="adapters.sap.actionforms.SAPVoucherReportForm" />

<%
request.setAttribute("topic","psvoucher_report_html");
String totalVouchers=sapVoucherReportForm.getTxtTotalVouchers();
String inProcessVouchers= sapVoucherReportForm.getTxtInProcessVoucher();
String processedVouchers= sapVoucherReportForm.getTxtProcessedVoucher();
String inQueueVouchers= sapVoucherReportForm.getTxtInQueueVoucher();
...
<html:html>
<head>
<title><bean:message key="title.SAPVoucherReport" /></title>
...
<html:javascript formName="sapVoucherStatusForm" dynamicJavascript="true" staticJavascript="false" />
...
<html:form name="sapVoucherReportForm" type="adapters.sap.actionforms.SAPVoucherReportForm" action="/sapRelayAction" >

<html:hidden property="operation" />
<html:hidden name="SAPVoucherReportForm" property="timezone" />
        ...
        <td width="152px">
          <table id="tab1" width="150px" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="140px" class="imgTabTile"><div align="center" class="tabText"><a class="tabTextLink" href="sapVoucherStatusListAction.do"><bean:message key="lbl.VoucherList" /></a> </div></td>
    ...
    <table width="700px" border="0" cellpadding="0" cellspacing="0" class=" bgClrLvl_3 borderClrLvl_2">
      <tr>
        ...
        <legend align="left" class="fieldSetHeading"><bean:message key="lbl.Search" />:</legend>
          ...
          <td width="34%">
            <html:select  name="SAPVoucherReportForm" property="voucherZone" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
              <html:options name="SAPVoucherReportForm" property="cboVoucherZone" />
            </html:select>				
          </td>
			    <td width="16%" align="right"><bean:message key="lbl.FromDate" />:</td>
			    <td width="35%">
            <html:hidden name="SAPVoucherReportForm" property="txtFromDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px"  />
              <script>
          ...
          <td></td>
			    ...
			    <td>
            <html:hidden name="SAPVoucherReportForm" property="txtToDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px"  />
              <script>
                createDateTo.render();
              </script>
          </td>
