<%@ page import="adapters.sap.beans.SAPAdapterConstant" %>
<%@ page import="adapters.sap.actionforms.SAPVoucherStatusListForm" %>
...
<bean:define id="pageCount" name="SAPVoucherStatusListForm" property="txtPageCount" />
<bean:define id="pageNo" name="SAPVoucherStatusListForm" property="txtPageNo" />
...
firstTableRow = true;
String status=((SAPVoucherStatusListForm)request.getAttribute("SAPVoucherStatusListForm")).getVoucherStatus();
%>

<html:html>
<head>
<title><bean:message key="title.SAPVoucherStatus" /></title>
...
<html:javascript formName="sapVoucherStatusListForm" dynamicJavascript="true" staticJavascript="false"/>
...
<html:form name="SAPVoucherStatusListForm" type="adapters.sap.actionforms.SAPVoucherStatusListForm" action="/sapRelayAction"  >

<html:hidden name="SAPVoucherStatusListForm" property="operation" />
<html:hidden name="SAPVoucherStatusListForm" property="timezone" />
<html:hidden name="SAPVoucherStatusListForm" property="txtPageNo" />
<html:hidden name="SAPVoucherStatusListForm" property="hdnType" />
        ...
        <tr>
          ...
          <td>
            <table id="tab2" width="150px" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="5px" class="imgTabLeft"></td>
                <td width="140px" class="imgTabTile"><div align="center" class="tabTextLink"><a class="tabTextLink" href="sapVoucherReportAction.do"><bean:message key="lbl.VoucherReport" /></a></div></td>
                <td width="5px" class="imgTabRight"></td>
              </tr>
            </table>
          </td>
        ...
        <td height="30px" colspan="2" align="center">
    		<fieldset style="width:670px; margin-top:10px">
			  ...
			  <tr>
				...
				<td width="31%">
          <bean:define id="checkVoucherStatus" name="SAPVoucherStatusListForm" property="voucherStatus" />
          <html:select  name="SAPVoucherStatusListForm" property="cboInvoiceStatus" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
            
            <%
              if(checkVoucherStatus.equals(SAPAdapterConstant.INQUEUE)){
            %>
              <option selected value="<%=SAPAdapterConstant.INQUEUE%>"><bean:message key="lbl.Inqueue" /></option>
            <%}else{%>
              <option value="<%=SAPAdapterConstant.INQUEUE%>"><bean:message key="lbl.Inqueue" /></option>
            <%}%>
            
            <%
              if(checkVoucherStatus.equals(SAPAdapterConstant.INPROCESS)){
            %>
              <option selected value="<%=SAPAdapterConstant.INPROCESS%>"><bean:message key="lbl.Inprocess" /></option>
            <%}else{%>
              <option value="<%=SAPAdapterConstant.INPROCESS%>"><bean:message key="lbl.Inprocess" /></option>
            <%}%>
            
            <%
              if(checkVoucherStatus.equals(SAPAdapterConstant.PROCESSED)){
            %>
              <option selected value="<%=SAPAdapterConstant.PROCESSED%>"><bean:message key="lbl.Processed" /></option>
            <%}else{%>
              <option value="<%=SAPAdapterConstant.PROCESSED%>"><bean:message key="lbl.Processed" /></option>
            <%}%>
            ...
            <html:hidden name="SAPVoucherStatusListForm" property="txtFromDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px" />
              <script>
			  ...
			  <tr>
				...
				<td>
          <html:select name="SAPVoucherStatusListForm" property="voucherZone" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
            <html:options name="SAPVoucherStatusListForm" property="cboInvoiceZone" />
          </html:select>				
        </td>
			    <td align="right"><bean:message key="lbl.ToDate" />:</td>
			    <td>
            <html:hidden name="SAPVoucherStatusListForm" property="txtToDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px" />
          ...
          <table class="bgClrLvl_F" id="data" width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr>
              <th width="6%" height="18px" >
                <%if(status.equalsIgnoreCase(SAPAdapterConstant.INPROCESS)){%>
              ...
              <th width="14%"><bean:message key="tbl.head.ProcessedDate" /></th>
                ...
                <% if(voucherArrayList.size()>0) {%>
                  <logic:iterate name="voucherArrayList" id="voucherArrayLists">
                    ...
                    <%}%>
                  <td>
                    <bean:define id="sapVoucherStatus" name="voucherArrayLists" property="sapVoucherStatus" />
                    <bean:define id="docId" name="voucherArrayLists" property="docID" />
                    <div align="center">
                      <logic:equal name="sapVoucherStatus" value="InProcess" >
                        <html:multibox name="SAPVoucherStatusListForm" property="radSelect" value="<%=docId%>" />
                      </logic:equal>
                      <logic:notEqual name="sapVoucherStatus" value="InProcess" >
                        <html:multibox name="SAPVoucherStatusListForm" disabled="true" property="radSelect" value="<%=docId%>" />
                      </logic:notEqual>
                    </div>
                  </td>

                  <td><bean:write name="voucherArrayLists" property="docName" /></td>
                  <td><bean:write name="voucherArrayLists" property="sapVoucherStatus" /></td>
