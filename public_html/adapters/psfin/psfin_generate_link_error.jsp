...
<head>
<title>
 <bean:message key="title.ErrorPage"/>
</title>
...
<tr>
<td align="center">
	<table id="tabParent" width="450px"  border="0" cellpadding="0" cellspacing="0">
		<tr>
    	<td>
			<table id="tab" width="150px" border="0" cellpadding="0" cellspacing="0">
      		<tr>
            <td width="5px" class="imgTabLeft"></td>
            <td width="140px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.Error" /></div></td>
	...
	<table width="450px" border="0" cellpadding="0" cellspacing="0" class="imgData borderClrLvl_2 bgClrLvl_4" id="borderClrLvl_2">
  <tr>
    <td >
