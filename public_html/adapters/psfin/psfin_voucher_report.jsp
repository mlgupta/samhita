...
<bean:define id="psfinVoucherReportForm" name="PSFINVoucherReportForm" type="adapters.psfin.actionforms.PSFINVoucherReportForm" />

<%
request.setAttribute("topic","psvoucher_report_html");
String totalVouchers=psfinVoucherReportForm.getTxtTotalVouchers();
String inProcessVouchers= psfinVoucherReportForm.getTxtInProcessVoucher();
String processedVouchers= psfinVoucherReportForm.getTxtProcessedVoucher();
String inQueueVouchers= psfinVoucherReportForm.getTxtInQueueVoucher();
...
<html:form name="psfinVoucherReportForm" type="adapters.psfin.actionforms.PSFINVoucherReportForm" action="/adapterRelayAction" >

<html:hidden property="operation" />
<html:hidden name="PSFINVoucherReportForm" property="timezone" />
        ...
        <td width="152px">
          <table id="tab1" width="150px" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="140px" class="imgTabTile"><div align="center" class="tabText"><a class="tabTextLink" href="psfinVoucherStatusListAction.do"><bean:message key="lbl.VoucherList" /></a> </div></td>
    ...
    <table width="700px" border="0" cellpadding="0" cellspacing="0" class=" bgClrLvl_3 borderClrLvl_2">
      <tr>
        ...
        <legend align="left" class="fieldSetHeading"><bean:message key="lbl.Search" />:</legend>
          ...
          <td width="34%">
            <html:select  name="PSFINVoucherReportForm" property="voucherZone" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
              <html:options name="PSFINVoucherReportForm" property="cboVoucherZone" />
            </html:select>				
          </td>
			    <td width="16%" align="right"><bean:message key="lbl.FromDate" />:</td>
			    <td width="35%">
            <html:hidden name="PSFINVoucherReportForm" property="txtFromDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px"  />
              <script>
          ...
          <td></td>
			    ...
			    <td>
            <html:hidden name="PSFINVoucherReportForm" property="txtToDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px"  />
              <script>
                createDateTo.render();
              </script>
          </td>
