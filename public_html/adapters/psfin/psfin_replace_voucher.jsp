...
<html:form action="/replaceVoucherAction" enctype="multipart/form-data" name="replaceVoucherForm" type="adapters.psfin.actionforms.ReplaceVoucherForm" >
<html:hidden name="replaceVoucherForm" property="voucherId" />
<html:hidden name="replaceVoucherForm" property="txtDocumentId" />
            ...
            <table width="95%"  align="left" border="0"  cellpadding="1" cellspacing="1">
              <tr>
                ...
                <tr>
                  ...
                  <td width="349">
                    <html:file name="replaceVoucherForm" property="frmFile" size="48" styleClass="borderClrLvl_2" style="width:425px"><bean:message key="btn.Browse" />
                    </html:file>
                  </td>
                </tr>
                <tr>
