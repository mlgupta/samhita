<%@ page import="adapters.pshr.beans.PSHRAdapterConstant" %>
<%@ page import="adapters.pshr.actionforms.PSHRVoucherStatusListForm" %>
...
<bean:define id="pageCount" name="PSHRVoucherStatusListForm" property="txtPageCount" />        
<bean:define id="pageNo" name="PSHRVoucherStatusListForm" property="txtPageNo" />
...
firstTableRow = true;
String status=((PSHRVoucherStatusListForm)request.getAttribute("PSHRVoucherStatusListForm")).getVoucherStatus();
%>
...
<html:javascript formName="pshrVoucherStatusListForm" dynamicJavascript="true" staticJavascript="false"/>
...
<html:form name="PSHRVoucherStatusListForm" type="adapters.pshr.actionforms.PSHRVoucherStatusListForm" action="/pshrRelayAction"  >

<html:hidden name="PSHRVoucherStatusListForm" property="operation" />
<html:hidden name="PSHRVoucherStatusListForm" property="timezone" /> 
<html:hidden name="PSHRVoucherStatusListForm" property="txtPageNo" /> 
<html:hidden name="PSHRVoucherStatusListForm" property="hdnType" />
        ...
        <tr>
          ...
          <td>
            <table id="tab2" width="150px" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="5px" class="imgTabLeft"></td>
                <td width="140px" class="imgTabTile"><div align="center" class="tabTextLink"><a class="tabTextLink" href="pshrVoucherReportAction.do"><bean:message key="lbl.VoucherReport" /></a></div></td>
                <td width="5px" class="imgTabRight"></td>
              </tr>
            </table>
          </td>
        ...
        <td height="30px" colspan="2" align="center">
    		<fieldset style="width:670px; margin-top:10px">
			  ...
			  <tr>
				...
				<td width="31%">
          <bean:define id="checkVoucherStatus" name="PSHRVoucherStatusListForm" property="voucherStatus" />
          <html:select  name="PSHRVoucherStatusListForm" property="cboInvoiceStatus" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">				
            
            <%
              if(checkVoucherStatus.equals(PSHRAdapterConstant.INQUEUE)){
            %>
              <option selected value="<%=PSHRAdapterConstant.INQUEUE%>"><bean:message key="lbl.Inqueue" /></option>
            <%}else{%>
              <option value="<%=PSHRAdapterConstant.INQUEUE%>"><bean:message key="lbl.Inqueue" /></option>
            <%}%>
            
            <%
              if(checkVoucherStatus.equals(PSHRAdapterConstant.INPROCESS)){
            %>
              <option selected value="<%=PSHRAdapterConstant.INPROCESS%>"><bean:message key="lbl.Inprocess" /></option>
            <%}else{%>
              <option value="<%=PSHRAdapterConstant.INPROCESS%>"><bean:message key="lbl.Inprocess" /></option>
            <%}%>
            
            <%
              if(checkVoucherStatus.equals(PSHRAdapterConstant.PROCESSED)){
            %>
              <option selected value="<%=PSHRAdapterConstant.PROCESSED%>"><bean:message key="lbl.Processed" /></option>
            <%}else{%>
              <option value="<%=PSHRAdapterConstant.PROCESSED%>"><bean:message key="lbl.Processed" /></option>
            <%}%>
            ...
            <html:hidden name="PSHRVoucherStatusListForm" property="txtFromDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px" />
              <script>
			  ...
			  <tr>
				...
				<td>
          <html:select name="PSHRVoucherStatusListForm" property="voucherZone" style="width:160px" styleClass="borderClrLvl_2 componentStyle bgClrLvl_5">
            <html:options name="PSHRVoucherStatusListForm" property="cboInvoiceZone" /> 
          </html:select>				
        </td>
			    <td align="right"><bean:message key="lbl.ToDate" />:</td>
			    <td>
            <html:hidden name="PSHRVoucherStatusListForm" property="txtToDate" styleClass="borderClrLvl_2 componentStyle" style="width:120px" />
          ...
          <table class="bgClrLvl_F" id="data" width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr>
              <th width="6%" height="18px" >
                <%if(status.equalsIgnoreCase(PSHRAdapterConstant.INPROCESS)){%>
                  ...
                  <td>
                    ...
                    <div align="center">
                      <logic:equal name="psVoucherStatus" value="InProcess" >
                        <html:multibox name="PSHRVoucherStatusListForm" property="radSelect" value="<%=docId%>" />
                      </logic:equal>
                      <logic:notEqual name="psVoucherStatus" value="InProcess" >
                        <html:multibox name="PSHRVoucherStatusListForm" disabled="true" property="radSelect" value="<%=docId%>" />
                      </logic:notEqual>
                    </div>
                  </td>
