...
<html:form action="/pshrReplaceVoucherAction" enctype="multipart/form-data" name="pshrReplaceVoucherForm" type="adapters.pshr.actionforms.PSHRReplaceVoucherForm" >
<html:hidden name="pshrReplaceVoucherForm" property="voucherId" />
<html:hidden name="pshrReplaceVoucherForm" property="txtDocumentId" />
            ...
            <table width="95%"  align="left" border="0"  cellpadding="1" cellspacing="1">
              <tr>
                ...
                <tr>
                  ...
                  <td width="349">
                    <html:file name="pshrReplaceVoucherForm" property="frmFile" size="48" styleClass="borderClrLvl_2" style="width:425px"><bean:message key="btn.Browse" />
                    </html:file>
                  </td>
                </tr>
                <tr>
