 ...
 *                                                                           *
 *****************************************************************************
 * $Id: InitiateSAPWf.java,v 1.0 2006/03/13 04:41:36 suved Exp $
 *****************************************************************************
 */
package adapters.sap.wf;
...
/**
 * Purpose            : Bean to initializeSAP workflow and add documents to queue
 * @author            : Suved Mishra
 * @version           : 1.0
...
public class InitiateSAPWf  {
  ...
  /**
   * Constructor for InitiateSAPWf Class
   * @param wfConnCache
   */
  public InitiateSAPWf(OracleConnectionCacheImpl wfConnCache){
    this.wfConnCache=wfConnCache;
    logger=Logger.getLogger("DbsLogger");
  }

  /**
   * Function to initialize SAP workflow and add the document ids to queue
   * @param docIds
   * @param managers
   * @param aclName
   * @param userName
  ...
  public void startReqWF(String itemTypeName,String processTypeName,
    ...
    try{ 
      ...
      logger.error("Exception occured in InitiateSAPWf "+e.toString());       
      e.printStackTrace();
      throw e;
    }finally{
