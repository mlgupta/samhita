 ...
 *                                                                           *
 *****************************************************************************
 * $Id: SAPResetVouchersWf.java,v 1.0 2006/03/13 04:41:36 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Bean to reset vouchers status to 'InQueue' for SAP
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class SAPResetVouchersWf  {
  ...
  /**
   * Constructor for SAPResetVouchersWf Class
   * @param wfConnCache
   */
  public SAPResetVouchersWf(OracleConnectionCacheImpl wfConnCache) {
