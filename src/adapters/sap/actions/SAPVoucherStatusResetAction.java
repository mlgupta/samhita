 ...
 *                                                                           *
 *****************************************************************************
 * $Id: SAPVoucherStatusResetAction.java,v 1.0 2006/03/13 06:42:00 suved Exp $
 *****************************************************************************
 */ 
package adapters.sap.actions;
/* adapters package references */
import adapters.sap.beans.SAPAdapterConstant;
import adapters.sap.beans.SAPVoucherStatusListBean;
import adapters.sap.wf.SAPResetVouchersWf;
...
/**
 *	Purpose: To reset the SAPVoucherStatus from Inqueue to Inprocess
 *  @author             Suved Mishra
 *  @version            1.0
 ...
 * 	Last Modified Date:    
 */
public class SAPVoucherStatusResetAction extends Action  {
 ...
 */
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering SAPVoucherStatusResetAction now...");
    ...
    if (httpSession.getAttribute("voucherArrayList")!=null){
      ...
      aclName = ((SAPVoucherStatusListBean)voucherArray.get(0)).getAclName();
    }
    ...
    SAPResetVouchersWf resetVouchers= new SAPResetVouchersWf(wfConnCache);
    try{
      if((aclName!=null) && (voucherToBeReset.length>0)){
        resetVouchers.reset(SAPAdapterConstant.ITYPE,aclName,voucherToBeReset);
        logger.info("Exiting SAPVoucherStatusResetAction now...");
      ...
      logger.error("Exception occured in SAPVoucherStatusResetAction" + exception.toString());
