 ...
 *                                                                           *
 *****************************************************************************
 * $Id: SAPB4ImageUploadAction.java,v 1.0 2006/03/13 12:52:38 suved Exp $
 *****************************************************************************
 */
...
import org.apache.struts.action.ActionMessages;
 /**
 * Purpose            : Action called to present sap_replace_voucher.jsp to
 *                      replace a document image.
 * @author            : Suved Mishra
 * @version           : 1.0
 * Date of Creation   : 03-13-2006
 * Last Modified Date : 
 * Last Modified By   : 
 */

public class SAPB4ImageUploadAction extends Action  {
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
  ...
  try{
    logger.info("Entering SAPB4ImageUploadAction now...");
    ...
    if(dbsLibrarySession.isConnected()){
      ...
      if(dbsFolder == null){
        ...
        SAPReplaceVoucherForm sapReplaceVoucherForm = new SAPReplaceVoucherForm();
        sapReplaceVoucherForm.setVoucherId(voucherId);
        sapReplaceVoucherForm.setTxtDocumentId(documentId);
        request.setAttribute("sapReplaceVoucherForm",sapReplaceVoucherForm);
  ...
  logger.info("Exiting SAPB4ImageUploadAction now...");
