 ...
 *                                                                           *
 *****************************************************************************
 * $Id: SAPReplaceVoucherB4Action.java,v 1.0 2006/03/13 06:32:21 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Action called to obtain a dummy document for SAP.
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class SAPReplaceVoucherB4Action extends Action  {
/**
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
  ...
  try{
    logger.info("Entering SAPReplaceVoucherB4Action now...");
  ...
  logger.info("Exiting SAPReplaceVoucherB4Action now...");
