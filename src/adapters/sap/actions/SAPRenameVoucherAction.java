 ...
 *                                                                           *
 *****************************************************************************
 * $Id: SAPRenameVoucherAction.java,v 1.0 2006/03/13 06:42:00 suved Exp $
 *****************************************************************************
 */ 
 ...
 * Last Modified By   : 
 */
public class SAPRenameVoucherAction extends Action  {
  ...
  public ActionForward execute( ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response ) throws IOException,ServletException{
    ...
    try{
      logger.info("Entering SAPRenameVoucherAction now...");
      ...
      logger.debug("Exiting SAPRenameVoucherAction : " + dbsEx.toString());
      /* Set up xmlString to be fetched to ps_response.jsp */
      StringBuffer sb = new StringBuffer();
      sb.append("<?xml version = '1.0' encoding = 'UTF-8'?>");
      sb.append("\n");
      ...
      logger.debug("Exiting SAPRenameVoucherAction : " + ex.toString());
      /* Set up xmlString to be fetched to ps_response.jsp */
      StringBuffer sb = new StringBuffer();
      sb.append("<?xml version = '1.0' encoding = 'UTF-8'?>");
      sb.append("\n");
      ...
      try{
        ...
        logger.error("Exiting SAPRenameVoucherAction : " + dbsEx.toString());
      }
      loginBean.terminateSession();
    }
    request.setAttribute("XmlResponse",xmlString);
    logger.info("Exiting SAPRenameVoucherAction now...");
