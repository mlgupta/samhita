 ...
 *                                                                           *
 *****************************************************************************
 * $Id: FindSAPVoucherBean.java,v 1.0 2006/03/14 06:32:21 ias Exp $
 *****************************************************************************
 */
 ...
 * Last Modified By   : 
 */
public class FindSAPVoucherBean {
  ...
  /**
   * Constructor for FindSAPVoucherBean Class
   * @param relativePath
   * @param screenId
   * @param voucherId
   */
  public FindSAPVoucherBean(String voucherId,String screenId,String relativePath) {
    logger = Logger.getLogger("DbsLogger");
    this.voucherId = voucherId;
    this.screenId = screenId;
    this.relativePath = relativePath;
    logger.info("FindSAPVoucherBean initialized successfully...");
  }
  ...
  private void initiateDBConnection()throws Exception{
    ...
    try {
      if(voucherCon==null || voucherCon.isClosed()){
        ...
        logger.info("Database Connection for FindSAPVoucherBean.java initialised.");
      }
    }
    catch (SQLException e) {
      logger.error("Exception occurred in FindSAPVoucherBean ...");
  ...
  public String getDocumentId()throws Exception{
    ...
    try {
      ...
      String sqlQuery = "select documentid from sap_data where "
  ...
  public String getVoucherURL()throws Exception{
    ...
    try{
      Statement voucherStatement = voucherCon.createStatement();
      String sqlQuery = "select url from sap_data where "
                       +"voucherid='"+voucherId+"' and "
                       +"screenid='"+screenId+"' ";
      logger.debug(sqlQuery); 
      ResultSet voucherSet = voucherStatement.executeQuery(sqlQuery);
  ...
  /**
   * Purpose : Function to add voucher data into sap_data table  
   * @throws java.lang.Exception
   * @param documentURL
   * @param documentId
   */
  public void enterVoucherData(String documentId,String documentURL)
    ...
    try{
      Statement voucherStatement = voucherCon.createStatement();
      String sqlQuery = "insert into sap_data values "
