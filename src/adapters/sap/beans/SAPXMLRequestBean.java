 ...
 *                                                                           *
 *****************************************************************************
 * $Id: SAPXMLRequestBean.java,v 1.0 2006/03/13 04:41:36 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Bean to read request attributes from xml file for SAP
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class SAPXMLRequestBean  {
  ...
  /**
   * Constructor for SAPXMLRequestBean Class
   * @param xmlStream
   */
  public SAPXMLRequestBean(InputStream xmlStream )throws Exception{
    try{
   ...
   * @param xmlString
   */
  public SAPXMLRequestBean(String xmlString ) throws Exception{
    try{
      logger = Logger.getLogger("DbsLogger");
