 ...
 *                                                                           *
 *****************************************************************************
 * $Id: AdapterRelayAction.java,v 1.1 2006/01/27 06:42:00 rajan Exp $
 *****************************************************************************
 */ 
 ...
 * 	Last Modified Date:    
 */
public class AdapterRelayAction extends Action {
    ...
    */
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
        ...
        //Based on operation for Voucher Status suitable actions are selected from struts config and sets the parameters in session
        if(operation.equals("search_voucher")
          ...
          ||operation.equals("reset_voucher")) {
              ...
              if(request.getParameter("cboInvoiceStatus")!=null && !((String)request.getParameter("cboInvoiceStatus")).equals("")){
                httpSession.setAttribute("cboInvoiceStatus",request.getParameter("cboInvoiceStatus"));
              }
              
              if(request.getParameter("voucherZone")!=null && !((String)request.getParameter("voucherZone")).equals("")){
                httpSession.setAttribute("voucherZone",request.getParameter("voucherZone"));
              }
              
              if(request.getParameter("cboInvoiceZone")!=null && !((String)request.getParameter("cboInvoiceZone")).equals("")){
                httpSession.setAttribute("cboInvoiceZone",request.getParameter("cboInvoiceZone"));
              }

              if(request.getParameter("txtFromDate")!=null && !((String)request.getParameter("txtFromDate")).equals("")){
                httpSession.setAttribute("txtFromDate",request.getParameter("txtFromDate"));
              }

              if(request.getParameter("txtToDate")!=null && !((String)request.getParameter("txtToDate")).equals("")){
        ...
        //Based on operation for Voucher Report suitable actions are selected from struts config and sets the parameters in session
