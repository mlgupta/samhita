 ...
 *                                                                           *
 *****************************************************************************
 * $Id: B4ImageUploadAction.java,v 1.4 2006/03/08 12:11:02 suved Exp $
 *****************************************************************************
 */
...
import org.apache.struts.action.ActionMessages;
 /**
 * Purpose            : Action called to present ps_voucher_replace.jsp to 
...
public class B4ImageUploadAction extends Action  {
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
  ...
  try{
    logger.info("Entering B4ImageUploadAction now...");
    ...
    if(dbsLibrarySession.isConnected()){
      ...
      if(dbsFolder == null){
        ...
        ReplaceVoucherForm replaceVoucherForm = new ReplaceVoucherForm();
        replaceVoucherForm.setVoucherId(voucherId);
        replaceVoucherForm.setTxtDocumentId(documentId);
        request.setAttribute("replaceVoucherForm",replaceVoucherForm);
  ...
  logger.info("Exiting B4ImageUploadAction now...");
