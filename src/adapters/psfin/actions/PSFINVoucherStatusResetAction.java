 ...
 *                                                                           *
 *****************************************************************************
 * $Id: PSVoucherStatusResetAction.java,v 1.1 2006/01/9 06:42:00 rajan Exp $
 *****************************************************************************
 */ 
package adapters.psfin.actions;
/* adapters package references */
import adapters.psfin.beans.PSFINAdapterConstant;
import adapters.psfin.beans.PSFINVoucherStatusListBean;
import adapters.psfin.wf.ResetVouchers;
...
/**
 *	Purpose: To reset the PSFINVoucherStatus from Inqueue to Inprocess
 ...
 * 	Last Modified Date:    
 */
public class PSFINVoucherStatusResetAction extends Action {
 ...
 */
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering PSVoucherStatusResetAction");
    ...
    if (httpSession.getAttribute("voucherArrayList")!=null){
      ...
      aclName = ((PSFINVoucherStatusListBean)voucherArray.get(0)).getAclName();
    }
    ...
    ResetVouchers resetVouchers= new ResetVouchers(wfConnCache);
    try{
      if((aclName!=null) && (voucherToBeReset.length>0)){
        resetVouchers.reset(PSFINAdapterConstant.ITYPE,aclName,voucherToBeReset);
        logger.info("Exiting PSFINVoucherStatusResetAction successfully");
        ...
        logger.error("Exception occured in PSFINVoucherStatusResetAction" + exception.toString());
