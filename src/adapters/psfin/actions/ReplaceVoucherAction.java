 ...
 *                                                                           *
 *****************************************************************************
 * $Id: ReplaceVoucherAction.java,v 1.12 2006/01/04 06:32:21 Rajan Exp $
 *****************************************************************************
 */
package adapters.psfin.actions;
/*adapters package references*/
import adapters.psfin.actionforms.ReplaceVoucherForm;
...
import org.apache.struts.upload.MultipartRequestHandler;
 /**
 * Purpose            : Action called to change a document's content.
 * @author            : Rajan Kamal Gupta
 * @version           : 1.0
 * Date of Creation   : 10-01-2006
 * Last Modified Date : 
 * Last Modified By   : 
 */
public class ReplaceVoucherAction extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering ReplaceVoucherAction");
      httpSession = request.getSession(false);
      //replaceVoucherId= Long.getLong(request.getParameter("voucherID")); 
      
      ReplaceVoucherForm replaceVoucherForm = (ReplaceVoucherForm)form;
      documentId= new Long(replaceVoucherForm.getTxtDocumentId());
      logger.debug("ReplaceVoucherForm : " + replaceVoucherForm);
      ...
      logger.error("Exception in ReplaceVoucherAction" +
      ...
      try{
        ...
        logger.debug("An error occurred in ReplaceVoucherAction"+
                      dbsEx.toString());
      }
    }
    logger.info("Exiting ReplaceVoucherAction" + "Uploading File Complete");
