 ...
 *                                                                           *
 *****************************************************************************
 * $Id: ReplaceVoucherB4Action.java,v 1.12 2006/01/11 06:32:21 suved Exp $
 *****************************************************************************
 */
...
import org.apache.struts.action.ActionMapping;
 /**
 * Purpose            : Action called to obtain a dummy document.
 * @author            : Suved Mishra
 * @version           : 1.0
 * Date of Creation   : 11-01-2006
 * Last Modified Date : 07-02-2006
 * Last Modified By   : Suved Mishra
 */

public class ReplaceVoucherB4Action extends Action {
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
  ...
  try{
    logger.info("Entering ReplaceVoucherB4Action now...");
  ...
  logger.info("Exiting ReplaceVoucherB4Action now...");
