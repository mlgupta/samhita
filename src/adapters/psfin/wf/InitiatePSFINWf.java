 ...
 *                                                                           *
 *****************************************************************************
 * $Id: InitiatePSFWf.java,v 1.1 2006/01/09 04:41:36 Maneesh Mishra Exp $
 *****************************************************************************
 */
package adapters.psfin.wf;
...
/**
 * Purpose            : Bean to initializePS workflow and add documents to queue 
 * @author            : Maneesh Mishra
 * @version           : 1.0
 * Date of Creation   : 12-01-2006
 * Last Modified Date : 
 * Last Modified By   : 
 */
public class InitiatePSFINWf  {
  ...
  /**
   * Constructor for InitiatePSFINWf Class
   * @param wfConnCache
   */
  public InitiatePSFINWf(OracleConnectionCacheImpl wfConnCache){
    this.wfConnCache=wfConnCache;
    logger=Logger.getLogger("DbsLogger");
  }

  /**
   * Function to initialize PS workflow and add the document ids to queue 
   * @param docIds
   * @param managers
   * @param aclName
   * @param userName
  ...
  public void startReqWF(String itemTypeName,String processTypeName,
              String userName,String aclName,String managers,String[] docIds){   
    ...
    try{ 
      ...
      logger.error("Exception occured in InitiatePSFWf "+e.toString());       
      e.printStackTrace();
    }finally{
