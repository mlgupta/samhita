 ...
 *                                                                           *
 *****************************************************************************
 * $Id: ResetVouchers.java,v 1.1 2006/01/09 04:41:36 Maneesh Mishra Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Bean to reset vouchers status to 'InQueue' 
...
public class ResetVouchers  {
  ...
  /**
   * Constructor for ResetVouchers Class
   * @param wfConnCache
   */
  public ResetVouchers(OracleConnectionCacheImpl wfConnCache) {
