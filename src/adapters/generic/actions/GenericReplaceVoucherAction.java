 ...
 *                                                                           *
 *****************************************************************************
 * $Id: GenericReplaceVoucherAction.java,v 1.3 2006/06/20 suved Exp $
 *****************************************************************************
 */
...
import org.apache.struts.upload.MultipartRequestHandler;
 /**
 * Purpose            : Action called to change a document's content for Generic ERP.
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class GenericReplaceVoucherAction extends Action  {
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering GenericReplaceVoucherAction now...");
      httpSession = request.getSession(false);
      //replaceVoucherId= Long.getLong(request.getParameter("voucherID")); 
      
      GenericReplaceVoucherForm replaceVoucherForm = (GenericReplaceVoucherForm)form;
      documentId= new Long(replaceVoucherForm.getTxtDocumentId());
      logger.debug("GenericReplaceVoucherForm : " + replaceVoucherForm);
      ...
      logger.error("Exception in GenericReplaceVoucherAction" +
      ...
      try{
        ...
        logger.error("An error occurred in GenericReplaceVoucherAction"+
                      dbsEx.toString());
      }
    }
    logger.info("Exiting GenericReplaceVoucherAction now...");
