 ...
 *                                                                           *
 *****************************************************************************
 * $Id: GenericShowImageVoucherAction.java,v 1.0 2006/06/21 06:32:21 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Action called to show image for Generic ERP.
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class GenericShowImageVoucherAction extends Action  {
/**
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
  ...
  try{
    logger.info("Entering GenericShowImageVoucherAction now...");
  ...
  logger.info("Exiting GenericShowImageVoucherAction now...");
