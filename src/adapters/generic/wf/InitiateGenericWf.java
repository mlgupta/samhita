 ...
 *                                                                           *
 *****************************************************************************
 * $Id: InitiateGenericWf.java,v 1.0 2006/06/23 04:41:36 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Bean to initializeERP workflow and add documents to queue
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class InitiateGenericWf  {
  ...
  private String ERPAclName = null;                   // aclName
  public ExceptionBean exBean;                        // exception bean                       

  /**
   * Constructor for InitiateGenericWf Class
   * @param wfConnCache
   */
  public InitiateGenericWf(OracleConnectionCacheImpl wfConnCache){
    this.wfConnCache=wfConnCache;
    logger=Logger.getLogger("DbsLogger");
  }

  /**
   * Function to initialize Generic ERP workflow and add the document ids to queue
   * @param docIds
   * @param managers
   * @param aclName
   * @param userName
  ...
  public void startReqWF(String itemTypeName,String processTypeName,
    ...
    try{ 
      ...
      logger.error("Exception occured in InitiateGenericWf "+e.toString());       
      e.printStackTrace();
      throw e;
    }finally{
