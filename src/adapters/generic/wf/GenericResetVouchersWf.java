 ...
 *                                                                           *
 *****************************************************************************
 * $Id: GenericResetVouchersWf.java,v 1.0 2006/06/23 04:41:36 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose            : Bean to reset vouchers status to 'InQueue' for Generic ERP
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class GenericResetVouchersWf  {
  ...
  /**
   * Constructor for GenericResetVouchersWf Class
   * @param wfConnCache
   */
  public GenericResetVouchersWf(OracleConnectionCacheImpl wfConnCache) {
