 ...
 *                                                                           *
 *****************************************************************************
 * $Id: PSHRReplaceVoucherAction.java,v 1.3 2006/03/09 suved Exp $
 *****************************************************************************
 */
...
import org.apache.struts.upload.MultipartRequestHandler;
 /**
 * Purpose            : Action called to change a document's content for PSHR.
 * @author            : Suved Mishra
 * @version           : 1.0
 ...
 * Last Modified By   : 
 */
public class PSHRReplaceVoucherAction extends Action  {
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering PSHRReplaceVoucherAction now...");
      httpSession = request.getSession(false);
      //replaceVoucherId= Long.getLong(request.getParameter("voucherID")); 
      
      PSHRReplaceVoucherForm replaceVoucherForm = (PSHRReplaceVoucherForm)form;
      documentId= new Long(replaceVoucherForm.getTxtDocumentId()); 
      logger.debug("PSHRReplaceVoucherForm : " + replaceVoucherForm);
      ...
      logger.error("Exception in PSHRReplaceVoucherAction" +
      ...
      try{
        ...
        logger.error("An error occurred in PSHRReplaceVoucherAction"+
                      dbsEx.toString());
      }
    }
    logger.info("Exiting PSHRReplaceVoucherAction now...");
