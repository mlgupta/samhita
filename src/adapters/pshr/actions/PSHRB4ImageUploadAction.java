 ...
 *                                                                           *
 *****************************************************************************
 * $Id: PSHRB4ImageUploadAction.java,v 1.0 2006/03/07 12:52:38 suved Exp $
 *****************************************************************************
 */
...
import adapters.pshr.actionforms.PSHRReplaceVoucherForm;
...
import org.apache.struts.action.ActionMessages;
 /**
 * Purpose            : Action called to present pshr_replace_voucher.jsp to 
 *                      replace a document image. 
 * @author            : Suved Mishra
 * @version           : 1.0
 * Date of Creation   : 02-07-2006
 * Last Modified Date : 
 * Last Modified By   : 
 */

public class PSHRB4ImageUploadAction extends Action  {
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
  ...
  try{
    logger.info("Entering PSHRB4ImageUploadAction now...");
    ...
    if(dbsLibrarySession.isConnected()){
      ...
      if(dbsFolder == null){
        ...
        PSHRReplaceVoucherForm pshrReplaceVoucherForm = new PSHRReplaceVoucherForm();
        pshrReplaceVoucherForm.setVoucherId(voucherId);
        pshrReplaceVoucherForm.setTxtDocumentId(documentId);
        request.setAttribute("pshrReplaceVoucherForm",pshrReplaceVoucherForm);
  ...
  logger.info("Exiting PSHRB4ImageUploadAction now...");
