 ...
 *                                                                           *
 *****************************************************************************
 * $Id: PSHRRenameVoucherAction.java,v 1.0 2006/03/07 06:42:00 suved Exp $
 *****************************************************************************
 */ 
 ...
 * @author            : Suved Mishra
 * @version           : 1.0
 * Date of Creation   : 07-03-06
 * Last Modified Date : 
 * Last Modified By   : 
 */
public class PSHRRenameVoucherAction extends Action  {
  ...
  public ActionForward execute( ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response ) throws IOException,ServletException{
    ...
    try{
      logger.info("Entering PSHRRenameVoucherAction now...");
      ...
      logger.debug("Exiting PSHRRenameVoucherAction : " + dbsEx.toString());
      /* Set up xmlString to be fetched to ps_response.jsp */
      StringBuffer sb = new StringBuffer();
      sb.append("<?xml version = '1.0' encoding = 'UTF-8'?>");
      sb.append("\n");
      ...
      logger.debug("Exiting PSHRRenameVoucherAction : " + ex.toString());
      /* Set up xmlString to be fetched to ps_response.jsp */
      StringBuffer sb = new StringBuffer();
      sb.append("<?xml version = '1.0' encoding = 'UTF-8'?>");
      sb.append("\n");
      ...
      try{
        ...
        logger.error("Exiting PSHRRenameVoucherAction : " + dbsEx.toString());
      }
      loginBean.terminateSession();
    }
    request.setAttribute("XmlResponse",xmlString);
    logger.info("Exiting PSHRRenameVoucherAction now...");
