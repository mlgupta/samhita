 ...
 *                                                                           *
 *****************************************************************************
 * $Id: FolderDocTreeAppendAction.java,v 20040220.8 2006/03/13 14:06:57 suved Exp $
 *****************************************************************************
 */
...
/**
 *	Purpose: To append folder in navigation tree
...
public class FolderDocTreeAppendAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering FolderDocTreeAppendAction now...");
    ...
    try{
      ...
      logger.debug("Performing Folder Doc Tree Append Action Complete");
    }catch(DbsException dex){
      exceptionBean = new ExceptionBean(dex);
      logger.error("An Exception occurred in FolderDocTreeAppendAction... ");
    ...
    logger.info("Exiting FolderDocTreeAppendAction now...");
