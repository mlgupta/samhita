 ...
 *                                                                           *
 *****************************************************************************
 * $Id: AclListSelectAction.java,v 20040220.16 2006/03/13 14:06:06 suved Exp $
 *****************************************************************************
 */
...
/**
 *	Purpose: To populate acl_list_select.jsp
 ...
 */
public class AclListSelectAction extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    AclListSelectForm aclForm=new AclListSelectForm();  
    // Validate the request parameters specified by the user
    ActionErrors errors = new ActionErrors();
    try{
      logger.info("Entering AclListSelectAction now...");
      ...
      if(singleAclName!=null && !singleAclName.equals("")) {
        ...
        pageCount=SearchUtil.listAclsPageCount(dbsLibrarySession,singleAclName,numRecords,forUser);
        if(pageNumber>pageCount){
          pageNumber=pageCount;
        }
        aclListSelect= SearchUtil.listAcls(dbsLibrarySession,singleAclName,pageNumber,numRecords,forUser);            
      ...
      request.setAttribute("AclListSelectForm",aclForm);
      ...
      logger.error("An Exception occurred in AclListSelectAction... ");
    ...
    logger.info("Exiting AclListSelectAction now...");
