 ...
 *                                                                           *
 *****************************************************************************
 * $Id: ChangePasswordB4Action.java,v 20040220.8 2006/03/17 14:19:04 suved Exp $
 *****************************************************************************
 */
...
/**
 *	Purpose: To display change_password.jsp.
...
public class ChangePasswordB4Action extends Action{
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    try{
      logger.info("Entering ChangePasswordB4Action now...");
      ...
      logger.error("An Exception occurred in ChangePasswordB4Action... ");
    ...
    logger.info("Exiting ChangePasswordB4Action now...");
