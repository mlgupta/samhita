...
/**
 *	Purpose:             To reject requisition for approval workflow .
 ...
 */
public class RejectRequisition extends WFFunctionAPI {
 ...
 public boolean execute(WFContext pWCtx){
  ...
  try{
    ...
    docWfStatusBean = new ChangeDocWfStatusBean((String)relativePath.getValue(),new Long((String)(docId.getValue())),"Rejected"); 
